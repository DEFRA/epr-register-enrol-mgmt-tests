...
export const config = {
  ...
  baseUrl: `https://epr-register-enrol-mgmt-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `epr-register-enrol-mgmt-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `epr-register-enrol-mgmt-tests-${process.env.ENVIRONMENT}`
        },
